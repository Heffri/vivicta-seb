...
The Wallenberg directory is a company roster, not a promise of publicly downloadable reports. Private-company accounts may require a registry or a user-uploaded PDF. Discovery includes collection ownership context to distinguish similarly named entities; a parent's or subsidiary's accounts do not replace the requested issuer.
