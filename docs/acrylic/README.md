...
- **Accuracy**: `eval/run.py --stored-kb data/kb` — values **257/327 (78.6%)**, pages **200/327 (61.2%)** over 327 scored rows (231 hand-verified `debt_maturity` labels across 87 companies, plus 96 income rows), zero model calls.
