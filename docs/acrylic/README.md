...
`Annual Report Parser-Setup-0.3.3.exe` (NSIS, ~141.6 MB). [v077](evidence/v077.md) The data
...
change — verified afterwards with no further model calls. Seven rounds so far, seeds 1–7, 67
...
[v072](evidence/v072.md); seed 7 measured the merged stack and deliberately landed nothing), and
