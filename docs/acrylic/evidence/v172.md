...
- Frontend gates passed: `npm run build`, `npm run lint` (existing repository warnings only), and
  `npm run e2e` (36 passed, 2 skipped).

## Integration

The branch began after fetching `team/main`; it was already at the acrylic baseline, so no
Sebastijan-main conflict needed resolution.
