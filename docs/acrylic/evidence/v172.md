...
Before delivery, the updated `team/main` was merged. Its one conflict in
`frontend/src/api.ts` was resolved by retaining both the team collection import and the v172
review-component import; no other conflict needed resolution.
