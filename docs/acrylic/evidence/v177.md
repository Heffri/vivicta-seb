...
- Frontend: `npm run build` green; `npm run lint` green with only the repository's pre-existing warnings; `npm run e2e` green after merging the current acrylic tip: 48 passed, 2 skipped (50 total).
