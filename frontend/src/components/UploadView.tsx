    ...
    <div className="space-y-6">
      ...
      <Workspace label="Report source" value={sourceView} onChange={setSourceView} pages={[
        ...
        <BatchProgress items={batch.items} busy={busy} stopRequested={batch.stopRequested} resultsCount={resultsCount}
          onStopAfterCurrent={batch.stopAfterCurrent} onRetry={(id, opts) => void batch.retry(id, opts)} onDownload={(id, listing) => void batch.download(id, listing)} onViewResults={onViewResults} onNavigate={onNavigate} />
