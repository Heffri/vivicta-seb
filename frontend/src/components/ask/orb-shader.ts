// Adapted from ElevenLabs UI Orb, MIT, Copyright (c) 2025 Eleven Labs Inc.
// https://github.com/elevenlabs/ui/blob/23c31bd3088814215a8b5d0bfb56b327cad1a578/apps/www/registry/elevenlabs-ui/ui/orb.tsx
// Full license: public/licenses/elevenlabs-ui.txt. Renderer uses local procedural noise.
...
void main() {
    ...
    // Soft spherical shading and an anti-aliased rim for the desktop theme.
    color.rgb *= 0.78 + 0.22 * sqrt(max(0.0, 1.0 - radius * radius));
    color.a *= 1.0 - smoothstep(0.975, 1.0, radius);
    gl_FragColor = color;
