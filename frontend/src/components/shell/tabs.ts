import { ListChecks, Columns3, FileText, Library, Network, MessageCircleQuestion, Settings, UploadCloud, type LucideIcon } from 'lucide-react'

export type Tab = 'extract' | 'results' | 'compare' | 'ask' | 'kb' | 'map' | 'settings' | 'review'
