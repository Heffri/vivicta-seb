...
from pipeline import extract as extract_mod, fetch, kb, llm, locate, parse, paths, ppt, collection, workbench, source_evidence
...
def fetch_report(body: FetchBody):
    ...
    if saved:
        try:
            return restore_source_pdf(saved[0]["stem"])
